<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/wwwroot/didi.xlove99.top/public/../application/wap/view/user/my_order.html";i:1553676123;s:69:"/www/wwwroot/didi.xlove99.top/application/wap/view/Public/header.html";i:1553069199;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="yj-content yj-mainH">
    <ul class="yj-pad-lr-big yj-mar-b">
        <?php if(is_array($myorders) || $myorders instanceof \think\Collection || $myorders instanceof \think\Paginator): $i = 0; $__LIST__ = $myorders;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?>
        <li class=" yj-radius-sm yj-mar-t yj-pad-lr-big yj-pad-tb yj-line-height-2 yj-bg-fff">
            <p class="yj-display-flex">
                ...
                <!--<span class="yj-right yj-text-sm yj-color-red">待作业</span>-->
                <!--<span class="yj-right yj-text-sm yj-color-gray-light">已完成</span>-->
            </p>
            <div class="yj-color-gray-light">
                <p>总价：<?php echo $order['p_info']['current_price']*$order['area']; ?>¥</p>
                <p>拼单时间：<?php echo $order['addtime']; ?></p>
                <p>拼单面积：<?php echo $order['area']; ?>亩</p>
            </div>
        </li>
